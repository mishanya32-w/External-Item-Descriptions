...
local trinkets = {
	...
	[16] = {"16", "Ноготь мамы", "{{MomBoss}} Каждую минуту Нога Мамы наступает на случайное место. Если сбросить брелок в комнате с врагами, Нога сразу раздавит это место"}, -- Mom's Toenai
